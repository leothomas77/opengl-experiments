...
vec3 sphere_pos_wor[] = { vec3( -2.0, 0.0, 0.0 ), vec3( 2.0, 0.0, 0.0 ),
													vec3( -2.0, 0.0, -2.0 ), vec3( 1.5, 1.0, -1.0 ) };
...
bool ray_sphere( vec3 ray_origin_wor, vec3 ray_direction_wor,
...
void glfw_mouse_click_callback( GLFWwindow *window, int button, int action,
																int mods ) {
