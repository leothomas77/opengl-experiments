...
//======================================================================================
//======================================================================================
HRESULT WINAPI DXUTCreateDevice(D3D_FEATURE_LEVEL reqFL,  bool bWindowed, int nSuggestedWidth, int nSuggestedHeight, unsigned int nSuggestedMSAASampleCount) {
    HRESULT hr = S_OK;
    ...
    deviceSettings.d3d11.sd.SampleDesc.Count = nSuggestedMSAASampleCount;
