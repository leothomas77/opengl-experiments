...
public:
    ...
    virtual void                GetProjParams( FLOAT *fFOV, FLOAT *fAspect, FLOAT *fNearPlane, FLOAT *fFarPlane )
    {
        *fFOV = m_fFOV;                 // Field of view
        *fAspect = m_fAspect;           // Aspect ratio
        *fNearPlane = m_fNearPlane;     // Near plane
        *fFarPlane = m_fFarPlane;       // Far plane
    }
...
//--------------------------------------------------------------------------------------
// CFirstPersonCamera U CModelViewerCamera
//--------------------------------------------------------------------------------------
class CFirstPersonAndOrbitCamera : public CFirstPersonCamera
{
public:
    CFirstPersonAndOrbitCamera();
    virtual void FrameMove( FLOAT fElapsedTime );
private:
    void SetRotateButtons(bool, bool, bool, bool);
};
