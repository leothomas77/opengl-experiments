...
void CD3DSettingsDlg::CreateControls()
{
    ...
    m_Dialog.SetFont( 0, L"Arial", 10, FW_NORMAL );
    m_Dialog.SetFont( 1, L"Arial", 12, FW_BOLD );
    ...
    m_RevertModeDialog.SetFont( 0, L"Arial", 10, FW_NORMAL );
    m_RevertModeDialog.SetFont( 1, L"Arial", 12, FW_BOLD );
