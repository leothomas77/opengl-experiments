                                         ...
                                         bool cullNear)
{
    ...
    // If they didn't ask for culling against near, skip it planes
...
void CDXUTSDKMesh::RenderMesh( UINT iMesh,
                               ...
                               UINT iSpecularSlot )
{
    // INTEL TODO: Skip entire mesh setup if no subsets are within frustum?
    ...
    for( UINT subset = 0; subset < pMesh->NumSubsets; subset++ )
    {
        ...
        pSubset = &m_pSubsetArray[ subsetArrayIndex ];
