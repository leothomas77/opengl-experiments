...
class Hair
{
  public:
    ...
    void SortPerBin(ID3D11DeviceContext *d3dDeviceContext, 
                    const D3DXMATRIXA16 &cameraWorldView,
                    UINT numBins);
  ...
  private:
    ...
    UINT                           *mIndices;
    UINT                            mNumBins;
    std::vector<UINT>               mInsertedIntoBins;
    std::vector<std::vector<UINT> > mBins;
