...
public:
    ...
    ID3D11RenderTargetView** GetRenderTargets(std::size_t arrayIndex = 0) { return &mRenderTargetElements[arrayIndex]; }
    ID3D11UnorderedAccessView* GetUnorderedAccessArray() { return mUnorderedAccessArray; }
    ID3D11UnorderedAccessView** GetUnorderedAccessArrays() { return &mUnorderedAccessArray; }
    ...
    ID3D11UnorderedAccessView** GetUnorderedAccesses(std::size_t arrayIndex = 0) { return &mUnorderedAccessElements[arrayIndex]; }
    ID3D11ShaderResourceView* GetShaderResource() { return mShaderResource; }
    ID3D11ShaderResourceView** GetShaderResources() { return &mShaderResource; }
...
public:
    ...
    ID3D11DepthStencilView** GetDepthStencils(std::size_t arrayIndex = 0) { return &mDepthStencilElements[arrayIndex]; }
    ID3D11ShaderResourceView* GetShaderResource() { return mShaderResource; }
    ID3D11ShaderResourceView** GetShaderResources() { return &mShaderResource; }
